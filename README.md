...
April XX, 2017 - V 1.2:
1. Changed tempo values on slider to white so that all values that change have the same color (white).  This makes all the values that need attention easy to spot.
