...
8. Code clean up: (made MillisecondHertzValueBase an abstract class - calculateValues is now a pure virtual function), DRYed up populateFieldsWithValues by using one function now to handle both MS and HZ - both objects get sliced to their base objects. removed unnecessary code
